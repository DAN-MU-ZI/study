...
![설치와 SQL부터 공간 분석, 공간 데이터 모델, 운영 관리, 종합 실습과 부록으로 이어지는 워크숍 학습 흐름](overview/learning-roadmap.png)

*그림 0-1. 워크숍은 환경·SQL 기초에서 출발하여 공간 분석과 고급 모델을 거친 뒤, 운영 관리와 종합 실습으로 마무리됩니다. 장 사이에서 주제가 바뀔 때는 이 흐름에서 현재 위치를 확인할 수 있습니다.*
