...
![평면 데카르트 좌표와 구면 경위도 좌표의 차이](geography/cartesian_spherical.jpg)
...
![로스앤젤레스와 파리 사이의 평면 직선과 대권 최단 경로 비교](geography/lax_cdg.jpg)
...
![국제 날짜 변경선을 통과하는 로스앤젤레스와 도쿄의 대권 경로](geography/lax_nrt.png)
