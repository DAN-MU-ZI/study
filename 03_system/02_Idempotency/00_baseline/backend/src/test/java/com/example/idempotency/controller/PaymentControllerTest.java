...
class PaymentControllerTest {
    ...
    void setUp() {
        ...
        PaymentService paymentService = new PaymentService(orderStore, paymentStore, mockPgService, 0L);
    ...
    void healthEndpoint_returnsHealthy() {
        ...
        assertThat(response.getBody()).containsEntry("service", "idempotency-baseline");
    }

    @Test
    void postPayments_returnsPaymentResponseShape() {
        ResponseEntity<PaymentDto.Response> response = paymentController.process(new PaymentDto.Request("1001", "cust-001", 15_000L));
    ...
    void getPayments_returnsEvidenceList() {
        paymentController.process(new PaymentDto.Request("1001", "cust-001", 15_000L));
